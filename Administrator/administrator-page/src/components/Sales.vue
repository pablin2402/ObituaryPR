...
export default {
  ...
  methods: {
     ...
     listarDetalles(id){
                ...
                axios.get('api/Sales/ListarDetalles/'+id).then(function(response){
    ...
    activarDesactivarMostrar(accion,item){
     ...
     listar(){
        ...
        axios.get("Sales/Listar").then(function(response){
    ...
    desactivar(){
      let me=this;
                ...
                axios.put('Sales/Anular/'+this.adId).then(function(){
                    me.adModal=0;
                    me.adAccion=0;
                    me.adNombre="";
                    me.adId="";
